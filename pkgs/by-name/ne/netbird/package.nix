...
#
# Vendored from nixpkgs (pkgs/by-name/ne/netbird/package.nix). Deltas from
# upstream:
  ...
  */
  availableComponents = {
    ...
    proxy = {
      ...
      # proxy/ is not in netbird's AGPL list (only management/signal/relay),
      # so it falls under the repo default: BSD-3-Clause.
      license = lib.licenses.bsd3;
    };
  };
...
buildGoModule (finalAttrs: {
  ...
  src = fetchFromGitHub {
    ...
    hash = "sha256-pLVHR0X754KjmR9zK/XUMGjO57yjksTp4Cr6od5kwxs=";
  };
